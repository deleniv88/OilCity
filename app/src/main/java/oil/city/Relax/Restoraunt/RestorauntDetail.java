...
public class RestorauntDetail extends AppCompatActivity implements RatingDialogListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    CardView comments, nameAndLocation, instagram, menu;
        ...
        btn_rating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (auth.getCurrentUser() == null){
                    final AlertDialog.Builder builder = new AlertDialog.Builder(RestorauntDetail.this);
...
//                    startActivity(intent);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(RestorauntDetail.this, "Розділ в процесі наповнення", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        admins.child(admin_detail_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                instagram.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(admin.getInstagram()));
                        startActivity(intent);
                    }
                });
        ...
        ratingBase.push()
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(RestorauntDetail.this, "Дякуємо за відгук!", Toast.LENGTH_SHORT).show();
                    }
                });
