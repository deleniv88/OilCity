...
public class HotelActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Common.isConnectedToInternet(getBaseContext()))
            ...
            Toast.makeText(HotelActivity.this, "Немає з’єднання з інтернетом!", Toast.LENGTH_SHORT).show();
            return ;
        }
...
//        userPhone.setText(phone1);
    ...
    private void loadEvent() {
        FirebaseRecyclerOptions<SkiModel> restOptions = new FirebaseRecyclerOptions.Builder<SkiModel>()
                .setQuery(hotelList, SkiModel.class)
                .build();
            ...
            protected void onBindViewHolder(@NonNull final SkiViewHolder holder, final int position, @NonNull final SkiModel model) {
                ...
                holder.setListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent event = new Intent(HotelActivity.this, HotelDetail.class);
                        event.putExtra("HotelId", adapter.getRef(position).getKey());
                        startActivity(event);
                    }
                });
