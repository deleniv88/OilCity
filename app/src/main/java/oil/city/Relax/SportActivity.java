...
public class SportActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Common.isConnectedToInternet(getBaseContext()))
            ...
            Toast.makeText(SportActivity.this, "Немеє з’єднання з інтернетом!", Toast.LENGTH_SHORT).show();
            return ;
        }
...
//                        Intent event = new Intent(RestorauntActivity.this, EventDetail.class);
