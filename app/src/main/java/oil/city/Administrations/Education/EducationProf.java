...
public class EducationProf extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;

    FirebaseDatabase database;
    DatabaseReference educationProfList;

    String educationProfId = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_education_prof);

        database = FirebaseDatabase.getInstance();
        educationProfList = database.getReference("EducationProf");
        ...
        if (Common.isConnectedToInternet(getBaseContext()))
            loadAdmin(educationProfId);
        else {
            Toast.makeText(EducationProf.this, "Немеє з’єднання з інтернетом!", Toast.LENGTH_SHORT).show();
            return ;
        }
...
////              holder.adress.setText(model.getAdress());
                ...
                holder.setListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent event = new Intent(EducationProf.this, EducationProfDetail.class);
                        event.putExtra("EducationProfId", adapter.getRef(position).getKey());
                        startActivity(event);
                    }
                });
            }
