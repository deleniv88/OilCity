...
public class EducationSchool extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;

    FirebaseDatabase database;
    DatabaseReference educationList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        educationList = database.getReference("Education");
        ...
        if (Common.isConnectedToInternet(getBaseContext()))
            loadAdmin(educationId);
        else {
            Toast.makeText(EducationSchool.this, "Немеє з’єднання з інтернетом!", Toast.LENGTH_SHORT).show();
            return ;
        }
...
////              holder.adress.setText(model.getAdress());
                ...
                holder.setListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent event = new Intent(EducationSchool.this, EducationSchoolDetail.class);
                        event.putExtra("EducationId", adapter.getRef(position).getKey());
                        startActivity(event);
                    }
                });
            }
