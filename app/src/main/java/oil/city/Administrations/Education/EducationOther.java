...
public class EducationOther extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;

    FirebaseDatabase database;
    DatabaseReference educationOtherList;

    String educationOtherId = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_education_other);

        database = FirebaseDatabase.getInstance();
        educationOtherList = database.getReference("EducationOther");
        ...
        if (Common.isConnectedToInternet(getBaseContext()))
            loadAdmin(educationOtherId);
        else {
            Toast.makeText(EducationOther.this, "Немеє з’єднання з інтернетом!", Toast.LENGTH_SHORT).show();
            return ;
        }
...
////              holder.adress.setText(model.getAdress());
                ...
                holder.setListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent event = new Intent(EducationOther.this, EducationOtherDetail.class);
                        event.putExtra("EducationOtherId", adapter.getRef(position).getKey());
                        startActivity(event);
                    }
                });
            }
