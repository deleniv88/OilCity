...
public class Company extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
...
//              holder.adress.setText(model.getAdress());
                ...
                holder.setListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent event = new Intent(Company.this, CompanyDetail.class);
                        event.putExtra("CompanyId", adapter.getRef(position).getKey());
                        startActivity(event);
                    }
                });
            }
