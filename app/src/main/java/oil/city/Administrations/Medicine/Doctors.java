...
import oil.city.ViewHolder.DoctorViewHolder;
...
public class Doctors extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    FirebaseRecyclerAdapter<AdministrationModel, DoctorViewHolder> adapter;
    Dialog sendDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorsList = database.getReference("Doctors");
        ...
        if (Common.isConnectedToInternet(getBaseContext()))
            ...
            Toast.makeText(Doctors.this, "Немеє з’єднання з інтернетом!", Toast.LENGTH_SHORT).show();
            return ;
        }
...
//        userPhone.setText(phone1);
    ...
    private void loadDoctors() {
        FirebaseRecyclerOptions<AdministrationModel> adminOptions = new FirebaseRecyclerOptions.Builder<AdministrationModel>()
                .setQuery(doctorsList, AdministrationModel.class)
                .build();
        adapter = new FirebaseRecyclerAdapter<AdministrationModel, DoctorViewHolder>(adminOptions) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull final DoctorViewHolder holder, final int position, @NonNull final AdministrationModel model) {
