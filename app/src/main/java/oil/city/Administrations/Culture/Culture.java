...
public class Culture extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cultureList = database.getReference("Culture");
        ...
        if (Common.isConnectedToInternet(getBaseContext()))
            ...
            Toast.makeText(Culture.this, "Немеє з’єднання з інтернетом!", Toast.LENGTH_SHORT).show();
            return ;
        }
...
////              holder.adress.setText(model.getAdress());
                ...
                holder.setListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent event = new Intent(Culture.this, CultureDetail.class);
                        event.putExtra("CultureId", adapter.getRef(position).getKey());
                        startActivity(event);
                    }
                });
            }
